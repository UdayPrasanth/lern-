...
import { courses as mockCourses } from '../data/lesson'; // Import from the new lesson.js file
...
function CoursesPage() {
  ...
  useEffect(() => {
    ...
    // To fetch from the API, uncomment the line below and remove the two lines above
    // fetchCourses();
  }, []);
